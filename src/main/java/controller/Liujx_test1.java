...
public class Liujx_test1 {

    autopulic au = new autopulic();
    private static Logger logger = Logger.getLogger(Liujx_test1.class);
    ...
    public void delete1() {
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.id("_mail_component_178_178"))).click();
        driver.manage().timeouts().pageLoadTimeout(10, TimeUnit.SECONDS);
    ...
    public void save() {
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.id("_mail_tabitem_0_133"))).click();
        driver.findElement(By.xpath("/html/body/div[1]/nav/div[1]/ul/li[2]")).click();
        System.out.println("写信定位成功");


        wait.until(ExpectedConditions.presenceOfElementLocated(By.className("nui-editableAddr-ipt"))).click();
    ...
    public void delete2() {
        ...
        au.mandatorySleep(3000);
        wait.until(ExpectedConditions.presenceOfElementLocated(By.id("_mail_component_182_182"))).click();

        driver.manage().timeouts().pageLoadTimeout(10, TimeUnit.SECONDS);

        //定位已发送邮件
        int ck1 = driver.findElements(By.className("il0")).size() - 1;
        logger.info("已发送邮件条数：" + ck1 + "-----------------");
        actions.clickAndHold(driver.findElements(By.className("il0")).get(0)).perform();
        actions.contextClick(driver.findElements(By.className("il0")).get(0)).perform();

        //点击删除邮件
        int size1 = driver.findElements(By.className("nui-menu-item-link")).size();
        driver.findElements(By.className("nui-menu-item-link")).get(size1 - 1).click();

        //wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[2]/div[1]/div/header/div/div[2]/div"))).click();
    ...
    @Test(priority = 8, description = "退出163账号",enabled = true)
    public void quit163() {
        driver.navigate().refresh();
    ...
    public void addName1() {
        ...
        WebElement element = driver.findElement(By.cssSelector("div.js-component-button.nui-mainBtn.nui-btn.nui-btn-hasIcon.nui-mainBtn-hasIcon  > span.nui-btn-text"));
        //JavascriptExecutor js = (JavascriptExecutor)driver;
    ...
    public void addName2() {
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.id("_mail_tabitem_1_134"))).click();
        driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
        driver.navigate().refresh();
        au.mandatorySleep(2000);
        driver.findElement(By.cssSelector("div.js-component-button.nui-mainBtn.nui-btn.nui-btn-hasIcon.nui-mainBtn-hasIcon > span.nui-btn-text")).click();
        //wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("div.js-component-button.nui-mainBtn.nui-btn.nui-btn-hasIcon.nui-mainBtn-hasIcon  > span.nui-btn-text"))).click();
