...
public class Liujx_test2 {
    ...
    //删除草稿箱邮件
    @Test(priority = 1, description = "删除草稿箱邮件", enabled = false)
    public void delete1() {

        //尝试点击
        au.showWait(wait,driver.findElement(By.id("_mail_component_178_178")),js);
        //wait.until(ExpectedConditions.elementToBeClickable(By.id("_mail_component_178_178"))).click();
    ...
    @Test(priority = 2, description = "存草稿箱操作", enabled = false)
    public void save() {
    ...
    //删除已发送邮件
    @Test(priority = 3, description = "删除已发送邮件", enabled = false)
    public void delete2() {
        driver.navigate().refresh();

        au.mandatorySleep(3000);
        //尝试点击
        au.showWait(wait,driver.findElement(By.id("_mail_component_182_182")),js);
        //wait.until(ExpectedConditions.elementToBeClickable(By.id("_mail_component_182_182"))).click();
    ...
    @Test(priority = 4, description = "发送邮件", enabled = false)
    public void send() {
    ...
    @Test(priority = 8, description = "退出163账号",enabled = false)
    public void quit163() {
        driver.navigate().refresh();
    ...
    /*新增，2022-03-18*/
    @Test(priority = 5, description = "新增联系人(不加分组)",enabled = false)
    ...
    @Test(priority = 6, description = "新增分组",enabled = false)
    ...
    @Test(priority = 7, description = "新增联系人(需加分组)",enabled = false)
    ...
    @Test(priority = 9,description = "删除第一个分组",enabled = true)
